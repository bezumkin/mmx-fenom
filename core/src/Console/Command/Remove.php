...
namespace MMX\Fenom\Console\Command;
...
class Remove extends Command
{
    ...
    protected static $defaultDescription = 'Remove mmxFenom extra from MODX 3';
    protected modX $modx;
    ...
    public function run(InputInterface $input, OutputInterface $output): void
    {
        ...
        $settings = SystemSetting::query()->where('namespace', App::NAMESPACE);
        foreach ($settings->cursor() as $setting) {
